  ...
  ArmonyController_2020a_Y_p_EE[6])
{
  ...
  switch (ct_tmp < 0.0 ? -(int32_T)(uint32_T)-ct_tmp : (int32_T)(uint32_T)ct_tmp)
  {
   case 0:
   ...
   case 1:
     ...
     */
    if ((ArmonyController_2020a_U_position_EE[0] *
         ArmonyController_2020a_U_position_EE[0] +
         ArmonyController_2020a_U_position_EE[1] *
         ArmonyController_2020a_U_position_EE[1]) +
        ArmonyController_2020a_U_position_EE[2] *
        ArmonyController_2020a_U_position_EE[2] > smax * smax) {
       ...
       */
      ct_tmp = cos(ArmonyController_2020a_U_position_EE[4]);
      st_idx_0_tmp = sin(ArmonyController_2020a_U_position_EE[4]);
      st_idx_0 = ArmonyController_2020a_U_position_EE[0] -
        ArmonyController_2020a_DW->L3 * st_idx_0_tmp;
      p_6_idx_0 = sin(ArmonyController_2020a_U_position_EE[5]);
      st_idx_1 = ArmonyController_2020a_U_position_EE[1] - -ct_tmp * p_6_idx_0 *
        ArmonyController_2020a_DW->L3;
      c_b_idx_1 = cos(ArmonyController_2020a_U_position_EE[5]);
      st_idx_2 = ArmonyController_2020a_U_position_EE[2] - c_b_idx_1 * ct_tmp *
        ArmonyController_2020a_DW->L3;
       ...
       */
      p_6 = cos(ArmonyController_2020a_U_position_EE[3]);
      smax = sin(ArmonyController_2020a_U_position_EE[3]);
  ...
  ArmonyController_2020a_Y_p_EE[6])
{
  ...
  /* external inputs */
  (void)memset(&ArmonyController_2020a_U_position_EE[0], 0, 6U * sizeof(real_T));
